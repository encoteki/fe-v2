...
export default function Header() {
  ...
  return (
    <header
      className={`${isHome && 'fixed left-0 right-0 top-0 z-50 bg-transparent'}`}
    >
      <div className="flex w-full items-center justify-between px-4 pt-4 tablet:px-6 tablet:pt-6 desktop:px-8 desktop:pt-8">
