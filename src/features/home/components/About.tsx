  ...
  return (
    <section id="about" className="home-container">
      <div className="max-w-full">
        <div className="rounded-2xl bg-primary-green px-4 py-6 tablet:rounded-4xl tablet:p-16 desktop:px-28 desktop:py-20">
...
function VMCard({
  ...
  return (
    <CardShell>
      <div className="flex flex-col rounded-4xl bg-white p-8">
